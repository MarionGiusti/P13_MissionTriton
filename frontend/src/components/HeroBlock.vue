<template>
  <div class="heroBlock">
    <v-carousel hide-delimiters>
      ...
      >
        <v-row
          class="title-wrap hidden-sm-and-down"
          align="center"
          justify="center"
        >
...
export default {
  ...
  data() {
    return {
      items: [
        {
          src: require("../assets/buzz-andersen-unsplash.jpg"),
        ...
        {
          src: require("../assets/sebastian-pena-lambarri-unsplash.jpg"),
...
.heroBlock {
  ...
  .title-wrap {
    ...
    .title {
      ...
      position: relative;
      z-index: 2;
      font: 500 50px "Amatic SC" !important;
    }
  }
}
</style>
